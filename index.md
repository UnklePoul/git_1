...
Для того чтобы скачать репозиторий со всей историей его изменения используется команда
```
git clone <удаленный репозиторий (Url-адрес)>
```
Для того чтобы скачать все изменения из удаленной ветки и объеденить с локальной веткой используется команда
```
git pull 
```

Для того чтобы загрузить локальные изменения в удаленный репозиторий используется команда
```
git pull <удаленнй репозиторий> <ветка>
```